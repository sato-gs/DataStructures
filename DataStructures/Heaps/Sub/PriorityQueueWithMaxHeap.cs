namespace DataStructures.Heaps.Sub
{
    ...
    public class PriorityQueueWithMaxHeap<T>
    {
        ...
        private void RestructureUp(int index)
        {
            ...
            // If the current child is equal to or less than its parent in terms of priority
            // Break out of the recursion
        ...
        private void RestructureDown(int index)
        {
            ...
            // If the current parent is equal to or greater than its larger child in terms of priority
            // Break out of the recursion
