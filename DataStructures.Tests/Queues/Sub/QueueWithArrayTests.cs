namespace DataStructures.Tests.Queues.Sub
{
    ...
    {
        private QueueWithArray<int> _queue;
        ...
        {
            // Arrange & Act & Assert
            Assert.Throws<InvalidOperationException>(() => new QueueWithArray<int>(capacity));
        }
        ...
        {
            // Arrange & Act & Assert
            Assert.DoesNotThrow(() => new QueueWithArray<int>(capacity));
        }
