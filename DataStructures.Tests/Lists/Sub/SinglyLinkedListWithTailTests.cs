    ...
    public class SinglyLinkedListWithTailTests
    {
        ...
        public void Get_WhenIndexIsNotOutOfRange_ShouldGetNodeAtGivenIndex(int index)
        {
            ...
            Assert.That(
                result,
                Is.Not.Null
                .And.Property(nameof(SinglyLinkedListWithTail<int>.Node.Value)).EqualTo(index));
        }
        ...
        public void Set_WhenIndexIsNotOutOfRange_ShouldSetNodeToGivenValueAtGivenIndex(int index, int value)
        {
            ...
            Assert.That(
                _list.Get(index),
                Is.Not.Null
                .And.Property(nameof(SinglyLinkedListWithTail<int>.Node.Value)).EqualTo(value));
        }
        ...
        public void Remove_WhenNodeWithGivenValueExists_ShouldRemoveNodeWithGivenValueAndReturnTrue(int index)
        {
            ...
            if (index == 10)
            {
                Assert.That(_list.Tail, Is.Not.EqualTo(result));
            }
        }
        ...
        public void RemoveFirst_WhenLinkedListIsNotEmpty_ShouldRemoveNodeFromHeadOfLinkedList(int range)
        {
            ...
            Assert.That(
                result,
                Is.Not.Null
                .And.Property(nameof(SinglyLinkedListWithTail<int>.Node.Value)).EqualTo(0));
            Assert.That(_list.Size, Is.EqualTo(prevSize - 1));
            Assert.That(_list.Head, Is.EqualTo(next));
            if (_list.Size == 0)
            {
                Assert.That(_list.Tail, Is.Null);
            }
        }
        ...
        public void RemoveLast_WhenLinkedListIsNotEmpty_ShouldRemoveNodeFromTailOfLinkedList(int range)
        {
            ...
            Assert.That(
                result,
                Is.Not.Null
                .And.Property(nameof(SinglyLinkedListWithTail<int>.Node.Value)).EqualTo(range - 1));
        ...
        public void Reverse_WhenCalled_ShouldReverseNodes(int range)
        {
            ...
            for (var i = 0; i <= range; i++)
            {
                ...
                Assert.That(
                    result,
                    Is.Not.Null
                    .And.Property(nameof(SinglyLinkedListWithTail<int>.Node.Value)).EqualTo(range - i));
            }
