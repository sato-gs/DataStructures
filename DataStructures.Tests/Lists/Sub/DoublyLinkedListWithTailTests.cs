    ...
    public class DoublyLinkedListWithTailTests
    {
        ...
        public void Get_WhenIndexIsNotOutOfRange_ShouldGetNodeAtGivenIndex(int index)
        {
            ...
            Assert.That(
                result,
                Is.Not.Null
                .And.Property(nameof(DoublyLinkedListWithTail<int>.Node.Value)).EqualTo(index));
        }
        ...
        public void Set_WhenIndexIsNotOutOfRange_ShouldSetNodeToGivenValueAtGivenIndex(int index, int value)
        {
            ...
            Assert.That(
                _list.Get(index),
                Is.Not.Null
                .And.Property(nameof(DoublyLinkedListWithTail<int>.Node.Value)).EqualTo(value));
        }
        ...
        public void RemoveFirst_WhenLinkedListIsNotEmpty_ShouldRemoveNodeFromHeadOfLinkedList(int range)
        {
            ...
            Assert.That(
                result,
                Is.Not.Null
                .And.Property(nameof(DoublyLinkedListWithTail<int>.Node.Value)).EqualTo(0));
        ...
        public void RemoveLast_WhenLinkedListIsNotEmpty_ShouldRemoveNodeFromTailOfLinkedList(int range)
        {
            ...
            Assert.That(
                result,
                Is.Not.Null
                .And.Property(nameof(DoublyLinkedListWithTail<int>.Node.Value)).EqualTo(range - 1));
        ...
        public void Reverse_WhenCalled_ShouldReverseNodes(int range)
        {
            ...
            for (var i = 0; i <= range; i++)
            {
                ...
                Assert.That(
                    result,
                    Is.Not.Null
                    .And.Property(nameof(DoublyLinkedListWithTail<int>.Node.Value)).EqualTo(range - i));
            }
