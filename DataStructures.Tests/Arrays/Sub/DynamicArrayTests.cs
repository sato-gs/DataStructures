namespace DataStructures.Tests.Arrays.Sub
{
    using System;
    using DataStructures.Arrays.Sub;
    ...
    public class DynamicArrayTests
    {
        ...
        public void SetUp()
        {
            _array = new DynamicArray<int>(_capacity);
        }
        ...
        {
            // Arrange & Act & Assert
            Assert.Throws<InvalidOperationException>(() => new DynamicArray<int>(capacity));
        }
        ...
        {
            // Arrange & Act & Assert
            Assert.DoesNotThrow(() => new DynamicArray<int>(capacity));
        }
